...
[AddComponentMenu( "Oryx/Audio/AudioController" )]
public class AudioController : SingletonMonoBehaviour<AudioController>, ISerializationCallbackReceiver
{
    ...
    /// </summary>
    public const string AUDIO_TOOLKIT_VERSION = "0.1";
    ...
    {
        AudioObject[] objs = FindObjectsOfType<AudioObject>();  // Flash compatible version
