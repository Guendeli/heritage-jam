...
namespace Oryx
{
    ...
    public class AudioController_Editor : EditorEx
    {
        ...
        protected override void LogUndo( string label )
        {
            ...
            Undo.RegisterCompleteObjectUndo( AC, "AudioToolkit: " + label );
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ( categoryFoldout = EditorGUILayout.Foldout( categoryFoldout, "Category Settings", foldoutStyle ) )
            {
                ...
                if ( curCat != null )
                {
                    ...
                    EditPrefab( ref curCat.audioMixerGroup, "Audio Mixer Group", "You can specify a Unity Audio Mixer Group here" );
            ...
            EditorGUILayout.Space();
            GUILayout.Label( string.Format( "----- Oryx Audio Toolkit v{0} -----  ", AudioController.AUDIO_TOOLKIT_VERSION ), centeredTextStyle );
