...
namespace Oryx
{
    public class EZStateComponent : MonoBehaviour
    {
        ...
        private void Fill()
        {
            ...
            if (_animation != null)
            {
#if UNITY_EDITOR && FALCON_ART
                if (_animation.playAutomatically)
                {
                    FLogger.Error("Play automatically is set in the animation in game object :{0}, which is used by FSimpleState , this will cause issues",this.gameObject.name, FLogTag.Misc);
                }
#endif
        ...
        {
            EZStateComponent targetComponent = actionModel.Target;
        ...
        public void ExecuteDoMove(DoMoveActionModel doMoveActionModel)
        {
            ...
            Tweener tween = target
                ...
                .SetEase(doMoveActionModel.EaseType);
            _cachedTweens.Add(tween);
        }
        ...
        public void ExecuteDoFade(DoFadeActionModel doFadeActionModel)
        {
            ...
            Tweener tween = target.DOFade(doFadeActionModel.FadeTo, doFadeActionModel.Duration)
                .SetEase(doFadeActionModel.EaseType);
            _cachedTweens.Add(tween);
        }
    ...
    {
        public EZStateComponent Target;
        public string State;
